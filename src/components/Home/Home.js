...
class Home extends React.Component {
  ...
  handleChangeForm(e){
    let _this=this
    let _form=Object.assign({},_this.state.form,{[e.target.name]:e.target.value})
    this.setState({form:_form})
  }    
  //提交表单
  btnConsultClik(){
    console.log(this.state)
    window.$http('/add',{},{},{},'post').then(function(res){
      console.log(res)
    }).catch(function(err){
      console.log(err)
    })
  ...
  initBanner(){
    let logoNode1=document.getElementById('logoSvg1')
    let logoNode2=document.getElementById('logoSvg2')
    let barNode=document.getElementById('navBar')
    barNode.style.background="#545454"
    barNode.style.boxShadow="0 0 0 transparent"
    logoNode1.style.display='none'
    logoNode2.style.display='block'
  }
  changBanner(){
    let logoNode1=document.getElementById('logoSvg1')
    let logoNode2=document.getElementById('logoSvg2')
    ...
    logoNode1.style.display='block'
    logoNode2.style.display='none'
  }
  initPosition(){
    ...
    return (
      <div className="Home">
        <div className="banner">
          ...
          <Btn btnClik={this.btnDownClick.bind(this)} text="立即下载" />
        </div>
        <div className="content">
          ...
          <Row className="show-grid con1" style={{marginBottom:'1rem'}}>
            <Col xs={12}  md={3} className="colStyle">
              <p className="pStyle0">独有“鹰眼”评分体系</p>
              <p className="pStyle1">通过海量房产质量数据建模分析</p>
              <p className="pStyle2">得出客观的楼盘综合价值评分</p>
              <embed  src="/static/img/icon_section1_score.svg" type="image/svg+xml"/>
            </Col>
            <Col xs={12}  md={3} className="colStyle">
              <p className="pStyle0">三大维度全方位监测</p>
              <p className="pStyle1">从工程质量、规划设计等三大维度</p>
              <p className="pStyle2">无死角监测真实楼盘质量</p>
              <embed  src="/static/img/icon_section1_camera.svg" type="image/svg+xml"/>
            </Col>
            <Col xs={12}  md={3} className="colStyle">
              <p className="pStyle0">公开透明  客观公正</p>
              <p className="pStyle1">打开房产质量“黑匣子”</p>
              <p className="pStyle2">楼盘评分及施工进度动态透明化</p>
              <embed  src="/static/img/icon_section1_chart.svg" type="image/svg+xml"/>
            </Col>
            <Col xs={12}  md={3} className="colStyle">
              <p className="pStyle0">严格依据国家制定标准</p>
              <p className="pStyle1">根据国家法定标准条文监督</p>
              <p className="pStyle2">违规行为一目了然</p>
              <embed  src="/static/img/icon_section1_standard.svg" type="image/svg+xml"/>
            </Col>
          </Row>
          <Link to="/score">
            <Btn text="什么是“鹰眼”评分体系" />
          </Link>
          
        </div>
        <div className="con2">
          <Row className="show-grid" style={{height:'100%'}}>
            <Col xs={6}  md={6} className="flexP2">
        ...
        <div className="con3">
            ...
            <Col xs={12} className="con3Main"  md={8} mdOffset={2}>
              ...
              <Row style={this.state.activePage===1? activeConStyle:null} className="show-grid mainConCon">
                ...
                <Col xs={12}  md={4} className="colStyle">
                  ...
                  <p className="pStyle0">地基工程</p>
                  <p className="pStyle1">属于隐蔽性工程</p>
                  <p className="pStyle1">在工程竣工验收中很难察觉</p>
                  <p className="pStyle2">对质量安全有着直接的影响</p>
                </Col>
                <Col xs={12}  md={4} className="colStyle">
                  <embed  src="/static/img/icon_section2_structure.svg" type="image/svg+xml"/>
                  <p className="pStyle0">主体结构</p>
                  <p className="pStyle1">建筑工程结构的安全性能</p>
                  <p className="pStyle1">是建筑工程的施工要点</p>
                  <p className="pStyle2">承担着项目的质量和安全问题</p>
                </Col>
                <Col xs={12}  md={4} className="colStyle">
                  <embed  src="/static/img/icon_section2_renovation.svg" type="image/svg+xml"/>
                  <p className="pStyle0">装饰装修工程</p>
                  <p className="pStyle1">是施工过程中必不可少的环节</p>
                  <p className="pStyle1">整体建筑工程功能实现方面</p>
                  <p className="pStyle2">发挥着重要的作用</p>
                </Col>
              </Row>
              ...
              <Row style={this.state.activePage===2? activeConStyle:null} className="show-grid mainConCon">
                ...
                <Col xs={12}  md={4} className="colStyle">
                  ...
                  <p className="pStyle0">室内规划设计</p>
                  <p className="pStyle1">多达近60项的标准</p>
                  <p className="pStyle1">从安全、舒适性、声污染等</p>
                  <p className="pStyle2">多方面评测内规划设计</p>
                </Col>
                <Col xs={12}  md={4} className="colStyle">
                  <embed  src="/static/img/icon_section3_outdoor.svg" type="image/svg+xml"/>
                  <p className="pStyle0">楼栋规划设计</p>
                  <p className="pStyle1">良好的通风采光条件、</p>
                  <p className="pStyle1">交通组织、良好的私密性等条件</p>
                  <p className="pStyle2">将直接影响用户的居住舒适性</p>
                </Col>
                <Col xs={12}  md={4} className="colStyle">
                  <embed  src="/static/img/icon_section3_zone.svg" type="image/svg+xml"/>
                  <p className="pStyle0">园区规划设计</p>
                  <p className="pStyle1">合理的消防逃生规划、安防规划</p>
                  <p className="pStyle1">需要优化设计和</p>
                  <p className="pStyle2">科学选用建筑材料</p>
                </Col>
              </Row>
              ...
              <Row style={this.state.activePage===3? activeConStyle:null} className="show-grid mainConCon">
                ...
                <Col xs={12}  md={4} className="colStyle">
                  ...
                  <p className="pStyle0">交通、医疗配套</p>
                  <p className="pStyle1">针对周边公交站点</p>
                  <p className="pStyle1">地铁线路、城市主干道等因素</p>
                  <p className="pStyle2">进行详尽分析</p>
                </Col>
                <Col xs={12}  md={4} className="colStyle">
                  <embed  src="/static/img/icon_section4_market.svg" type="image/svg+xml"/>
                  <p className="pStyle0">生活服务配套</p>
                  <p className="pStyle1">全方位考量综合购物等</p>
                  <p className="pStyle1">生活商圈综合配套</p>
                  <p className="pStyle2">快速鉴别楼盘舒适度及附加值</p>
                </Col>
                <Col xs={12}  md={4} className="colStyle">
                  <embed  src="/static/img/icon_section4_gas_station.svg" type="image/svg+xml"/>
                  <p className="pStyle0">解析不利因素</p>
                  <p className="pStyle1">密集流动人员、垃圾处理站</p>
                  <p className="pStyle1">粉尘污染源头、化工企业</p>
                  <p className="pStyle2">十余项不利因素替您层层把关</p>
                </Col>
              </Row>
              ...
              <Row style={this.state.activePage===4? activeConStyle:null} className="show-grid mainConCon">
                ...
                <Col xs={12}  md={4} className="colStyle">
                  ...
                  <p className="pStyle0">户内七大阶段落实评测</p>
                  <p className="pStyle1">根据工程施工进度划分七大阶段</p>
                  <p className="pStyle1">重点关注“隐蔽工程”</p>
                  <p className="pStyle2">工序工艺可视化</p>
                </Col>
                <Col xs={12}  md={4} className="colStyle">
                  <embed  src="/static/img/icon_section5_park.svg" type="image/svg+xml"/>
                  <p className="pStyle0">园区规划全程监控</p>
                  <p className="pStyle1">关注楼盘绿化率与绿化质量</p>
                  <p className="pStyle1">鉴别园林实时标准是否缩水</p>
                  <p className="pStyle2">虚假宣传无所遁形</p>
                </Col>
                <Col xs={12}  md={4} className="colStyle">
                  <embed  src="/static/img/icon_section5_safety.svg" type="image/svg+xml"/>
                  <p className="pStyle0">全方位关注居住安全</p>
                  <p className="pStyle1">关注消防安保系统软硬件落实</p>
                  <p className="pStyle1">精准对比规划与实际落实</p>
                  <p className="pStyle2">数量与质量同步校准</p>
                </Col>
              </Row>
              ...
              <form style={{padding:'.2rem .6rem'}}>
                ...
                <FormGroup>
                  <FormControl
                    type="text"
                    name="buildName"
                    value={this.state.form.buildName}
          ...
          <Row className="show-grid">
              <Col xs={12} className=""  md={8} mdOffset={2}>
                ...
                <Row className="show-grid coopItemWap" style={{marginTop:'.3rem'}}>
                  <Col xs={12} className="coopItem"  md={3}>
              ...
              <Col xs={12} className=""  md={6} mdOffset={3}>
                <Row className="show-grid coopItemWap">
                  <Col xs={12} className="coopItem"  md={4}>
